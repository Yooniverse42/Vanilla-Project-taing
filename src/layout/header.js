...
async function setUserDataOnTemplate() {
  ...
  // const { collectionId, username, id, avatar } = user.record;
  ...
  console.log(headerTemplate.content);
}

// setUserDataOnTemplate();
// console.log(headerTemplate.content);
...
//             <div class="profile_wrapper">
//               <div class="profile_container">
//                 <img src="/icons/icon.svg" alt="프로필" />
//                 <h2>이듬</h2>
//                 <button type="button" onclick="location.href='/src/pages/profile_edit_detail/index.html'">
//                   <span>프로필 편집</span>
//                 </button>
...
console.log(cHeader);
console.log(cHeader.shadowRoot);
